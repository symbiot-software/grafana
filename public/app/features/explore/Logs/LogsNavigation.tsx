...
import { TOP_BAR_LEVEL_HEIGHT, NAV_BAR_LEVEL_HEIGHT } from 'app/core/components/AppChrome/types';
...
const getStyles = (theme: GrafanaTheme2, oldestLogsFirst: boolean) => {
  const navContainerHeight = `calc(100vh - 2*${theme.spacing(2)} - ${TOP_BAR_LEVEL_HEIGHT+NAV_BAR_LEVEL_HEIGHT}px)`;
  return {
    navContainer: css`
